 ...
 */
final class Version20230512083619 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE set_menu ADD CONSTRAINT FK_E8C2D81A2B4B60FB FOREIGN KEY (drinks_id) REFERENCES drinks (id) ON UPDATE NO ACTION ON DELETE SET NULL');
